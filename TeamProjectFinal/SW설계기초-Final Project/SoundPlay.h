...
#define SOUNDEFFECT_COLLISION L"EXPLOSION.mp3"		//DAMAGE 효과음
...
void PlayBgm() {
	...
	mciSendCommandW(dwID, MCI_PLAY, MCI_DGV_PLAY_REPEAT, (DWORD)(LPVOID)&openBgm);    //음악 반복 재생
}
...
void PlayDamageSound() {
	...
	mciSendCommandW(dwIDSE, MCI_PLAY, MCI_DGV_PLAY_REPEAT, (DWORD)(LPVOID)&openDamageSound);    //음악을 한 번 재생
